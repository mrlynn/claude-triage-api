  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-pine/60">
          Normally you would never see this. It is the classification that
          decides which queue your message lands in and how fast someone reads
          it.
        </p>
        ...
        {!outcome && state !== "sending" && (
          <div className="mt-4 rounded-lg border border-dashed border-pine/25 p-8 text-center text-sm text-pine/45">
            Submit a ticket and the triage result appears here.
          </div>
        )}

        {state === "sending" && (
          <div className="mt-4 rounded-lg border border-pine/20 p-8 text-center text-sm text-pine/60 animate-pulse">
            Reading your message&hellip;
          </div>
        )}
